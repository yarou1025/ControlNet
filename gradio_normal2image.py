...
model = create_model('/Users/yaroushe/Documents/GitHub/ControlNet/ControlNet/models/cldm_v15.yaml').cpu()
model.load_state_dict(load_state_dict('/Users/yaroushe/Documents/GitHub/ControlNet/ControlNet/models/control_sd15_normal.pth', location='cuda'))
model = model.cuda()
